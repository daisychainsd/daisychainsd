...
Shopify still supplies products. Its replacement, product/image import and opening inventory count remain unfinished; `MERCH_BACKEND` is unset. The order-recovery deployment does not activate that migration. Independent Shopify/Bandcamp/booth order history is outside the website Stripe recovery.
