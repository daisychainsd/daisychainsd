...
- The September 22 order recovery restored four paid physical website orders. Eight physical Bandcamp orders were also imported and replay-verified, retaining their Bandcamp shipped dates. Check older orders against Pirate Ship, then mark shipped/unshipped in Ops; tracking is optional and CSV export does not mark shipped. The [recovery/deployment record](https://github.com/daisychainsd/daisychain-site/blob/main/ORDER-RECOVERY-2026-09-22.md) tracks activation of the direct-order webhook and hourly reconciliation.
